...
namespace memory_pool {
    [[nodiscard]] size_t roundUpToPowerOf2(size_t n);
    ...
    private:
        ...
        mutable std::mutex perThreadPoolsMutex;
        mutable std::map<NativeThreadHandle, std::unique_ptr<pool>> perThreadPools;
    };
}
